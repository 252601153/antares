/**
 * @file PostgreSQLParser.ts
 * @description PostgreSQL SQL 解析器
 *
 * 本文件实现了 PostgreSQL SQL 语句的解析功能。
 * 用于导入时分析 SQL 文件结构。
 *
 * @module /Users/zhangzhiming/code/antares/src/main/libs/parsers/PostgreSQLParser
 */
